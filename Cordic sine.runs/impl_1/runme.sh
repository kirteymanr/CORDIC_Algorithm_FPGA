...
HD_PWD='C:/Users/kirte/App Software/Vivado Projects/CORDIC/Cordic sine/Cordic sine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log board_interface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source board_interface.tcl -notrace
