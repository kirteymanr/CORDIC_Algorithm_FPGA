...
HD_PWD='C:/Users/kirte/App Software/Vivado Projects/CORDIC/Cordic sine/Cordic sine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log board_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source board_interface.tcl
